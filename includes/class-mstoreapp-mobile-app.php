...
class Mstoreapp_Mobile_App {
	...
	private function load_dependencies() {
		...
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-mstoreapp-mobile-app-block.php';
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-mstoreapp-mobile-app-build.php';
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-mstoreapp-mobile-app-push.php';
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-mstoreapp-mobile-app-block-list.php';
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-mstoreapp-mobile-app-demo.php';
	...
	private function define_admin_hooks() {
        ...
        $plugin_block = new Mstoreapp_Mobile_App_Block( $this->get_plugin_name(), $this->get_version() );

        $this->loader->add_action('admin_menu', $plugin_block, 'mstoreapp_mobile_app_menu');

        $plugin_build = new Mstoreapp_Mobile_App_Build( $this->get_plugin_name(), $this->get_version() );

        $this->loader->add_action('admin_menu', $plugin_build, 'mstoreapp_mobile_app_menu');

        $plugin_push = new Mstoreapp_Mobile_App_Push( $this->get_plugin_name(), $this->get_version() );

        $this->loader->add_action('admin_menu', $plugin_push, 'mstoreapp_mobile_app_menu');

        $plugin_demo = new Mstoreapp_Mobile_App_Demo( $this->get_plugin_name(), $this->get_version() );

        $this->loader->add_action('admin_menu', $plugin_demo, 'mstoreapp_mobile_app_menu');
	...
	private function define_public_hooks() {
        ...
        $this->loader->add_action('wp_ajax_mstoreapp-children', $plugin_public, 'children');
        $this->loader->add_action('wp_ajax_nopriv_mstoreapp-children', $plugin_public, 'children');
