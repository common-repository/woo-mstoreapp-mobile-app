...
// Don't duplicate me!
if ( !class_exists ( 'ReduxFramework_pages' ) ) {

    /**
     * Main ReduxFramework_pages class
     *
     * @since       1.0.0
     */
    class ReduxFramework_pages {
        ...
        public function render () {
            ...
            echo '<div class="redux-pages-accordion" data-new-content-title="' . esc_attr ( sprintf ( __ ( 'New %s', 'redux-framework' ), $this->field[ 'content_title' ] ) ) . '">';
            ...
            if ( isset ( $this->value ) && is_array ( $this->value ) && !empty ( $this->value ) ) {
                ...
                foreach ( $pages as $slide ) {
                    ...
                    echo '<div class="redux-pages-accordion-group"><fieldset class="redux-field" data-id="' . $this->field[ 'id' ] . '"><h3><span class="redux-pages-header">' . $slide[ 'title' ] . '</span></h3><div>';
                    ...
                    echo '<img class="redux-pages-image" id="image_image_id_' . $x . '" src="' . $slide[ 'thumb' ] . '" alt="" target="_blank" rel="external" />';
                    echo '</a>';
                    echo '</div>';

                    echo '<div class="redux_pages_add_remove">';
                    ...
                    echo '<ul id="' . $this->field[ 'id' ] . '-ul" class="redux-pages-list">';
                    ...
                    echo '<li><a href="javascript:void(0);" class="button deletion redux-pages-remove">' . __ ( 'Delete', 'redux-framework' ) . '</a></li>';
            ...
            if ( $x == 0 ) {
                echo '<div class="redux-pages-accordion-group"><fieldset class="redux-field" data-id="' . $this->field[ 'id' ] . '"><h3><span class="redux-pages-header">' . esc_attr ( sprintf ( __ ( 'New %s', 'redux-framework' ), $this->field[ 'content_title' ] ) ) . '</span></h3><div>';

                $hide = ' hide';

                echo '<div class="screenshot' . $hide . '">';
                echo '<a class="of-uploaded-image" href="">';
                echo '<img class="redux-pages-image" id="image_image_id_' . $x . '" src="" alt="" target="_blank" rel="external" />';
                echo '</a>';
                echo '</div>';
            ...
            echo '</div><a href="javascript:void(0);" class="button redux-pages-add button-primary" rel-id="' . $this->field[ 'id' ] . '-ul" rel-name="' . $this->field[ 'name' ] . '[title][]' . $this->field['name_suffix'] .'">' . sprintf ( __ ( 'Add %s', 'redux-framework' ), $this->field[ 'content_title' ] ) . '</a><br/>';
        }
        ...
        public function enqueue () {
            ...
            if (!$this->parent->args['dev_mode']){
                ...
                wp_enqueue_style (
                    'redux-field-pages-css', 
                    ReduxFramework::$_url . 'inc/fields/pages/field_pages.css', 
                    array(),
                    time (), 
                    'all'
                );
            ...
            wp_enqueue_script (
                'redux-field-pages-js', 
                ReduxFramework::$_url . 'inc/fields/pages/field_pages' . Redux_Functions::isMin () . '.js', 
